...
def parseCommandLineArguments():
	...
	logOutputPath = outputVideoPath.replace(".avi", ".log")
	confidence = args["confidence"]
	threshold = args["threshold"]
	USE_GPU = args["use_gpu"]

	return LABELS, weightsPath, configPath, inputVideoPath, outputVideoPath, logOutputPath, confidence, threshold, USE_GPU
